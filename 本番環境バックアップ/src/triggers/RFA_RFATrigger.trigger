 ...
 *
 *  Updated by Jia Hu from 2013/10/25                                    
 */
trigger RFA_RFATrigger on RFA__c (
	...
	system.debug('------ RFA_RFATrigger on RFA__c ');	
    ...
    //replaced by Jia Hu on 2014/05/22
    ...
    //new Trigger Handler by Jia Hu from 2014/05/20
    RFA_TriggerHandler instRFA_TriggerHandler = new RFA_TriggerHandler();
	...
	*/ 
    ...
    /************************************** BEFORE BLOCK STARTS ****************************************/        
        if(trigger.IsBefore)
        {
            ...
            if(trigger.IsInsert) 
            {  
            	system.debug('------ RFA Trigger Before Insert: ' + trigger.new);         
            	...
            	//new handler added by Jia Hu on 2014/05/20           	
            	instRFA_TriggerHandler.processRFAsInBeforeInsertTrigger(trigger.new);           	
            	/*    
                for(RFA__c rfa : Trigger.new)
                {
                ...
                */
                ...
                //replaced by Jia Hu on 2014/05/20               
            ...
            if(trigger.isUpdate)
            {
            	//added by Jia Hu on 2014/05/21
            	instRFA_TriggerHandler.processRFAsInBeforeUpdateTrigger(trigger.new, trigger.oldMap);
                ...
                try{                     	
                    ...
                    {                                               
                        ...
                        {
                        	//replaced by Jia Hu on 2014/05/21
    ...
    /****************************************** AFTER BLOCK STARTS *********************************************/    
        ...
        {  
            ...
            if(trigger.IsInsert) //after insert                      
            {
            	...
            	//new handler added by Jia Hu on 2014/05/21           	
            	instRFA_TriggerHandler.processRFAsInAfterInsertTrigger(trigger.new);              	
            ...
            {    
            	//New Handler added by Jia Hu on 2014/05/21
            	instRFA_TriggerHandler.processRFAsInAfterUpdateTrigger(trigger.new, trigger.oldMap);
                ...
                for(Rfa__c rfa: Trigger.New)
                {
                    ...
                    {   /* 2013/10/23 by Jia Hu
                        ...
                        if(RFA_AP05_RFATrigger.createPDF) {
                        	// modified by yoshinari 2014/05/28
                        	// Pdf generate processing change of Commercial  
							...
							{
								// using VF page: CM_VFP04_CM_DtailsAsPDF
								CM_WS04_PDFGeneratorCM.PDFGenerator(rfa.Id, UserInfo.getSessionId());				
							}
							else 
							{
								//using VF page: RFA_VFP04_CM_DetailsAsPDF
	...
	*/	
	if(Trigger.isBefore && Trigger.isDelete) {
		instRFA_TriggerHandler.processRFAsInBeforeDeleteTrigger(trigger.old);
		/*
